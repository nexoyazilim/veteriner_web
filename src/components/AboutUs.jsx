      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-12">
          ...
          <div className="relative h-80 w-full overflow-hidden rounded-xl">
            <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCTFIlQRTPWwEhrOmpvxgusavSAex9TUaLRAfQ8Ijk_VhP4ZqS8de31RtTtMuQyvUMiM_5ygOC4vSdlA24mwQ9J-jHlg5ffB5iiDn7xvnwBIgAdoUx5X-TNxnqCzznWLxLLkfyjFYnd6rRXqtITX_e7aGbtmVpULTFpLT_tpYLCrLJtUf75RNky0heLdni8l9v6dl-yNjta9VpkWx4x4GcLkmA5RnD-ddCnXGrOEgdxp12ouTLXSbZFA_asPXnySE12_yhJc9pwWao")'}}></div>
          ...
          <section>
            <h2 className="mb-6 text-3xl font-bold text-foreground-light dark:text-foreground-dark">Meet Our Vets</h2>
          ...
          {/* Our Mission Section */}
          <section>
            <h2 className="mb-4 text-3xl font-bold text-foreground-light dark:text-foreground-dark">Our Mission</h2>
          ...
          <section>
            <h2 className="mb-6 text-3xl font-bold text-foreground-light dark:text-foreground-dark">Our Community Initiatives</h2>
          ...
          <section>
            <h2 className="mb-6 text-3xl font-bold text-foreground-light dark:text-foreground-dark">Client Testimonials</h2>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col gap-4 rounded-lg border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark p-6">
