        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center gap-2 md:gap-3 md:ml-2">
            <Link to="/" className="block" aria-label="PetCare Clinic Home">
             <img src="/assets/images/site_logo.png" alt="PetCare Clinic Logo" className="h-12 sm:h-14 md:h-16 w-auto" />
            </Link>
            <Link to="/" className="text-lg sm:text-xl font-bold">PetCare Clinic</Link>
          </div>
          <nav className="hidden md:flex items-center gap-6">
            ...
            <NavLink to={"/gallery"} className={({ isActive }) => `text-sm font-medium transition-colors ${isActive ? 'text-primary' : 'hover:text-primary'}`}>Gallery</NavLink>
          ...
          <div className="flex items-center gap-6">
            <Link to="/contact#booking-form" className="hidden md:flex items-center justify-center rounded-full h-8 px-4 bg-primary text-foreground-dark text-xs font-semibold hover:bg-primary/90 transition-colors">
              Book Appointment
            </Link>
        ...
        {open && (
          <div className="md:hidden py-3 border-t border-border-light dark:border-border-dark text-center">
            <div className="flex flex-col gap-3">
              ...
              <NavLink to={"/gallery"} className={({ isActive }) => `text-sm font-medium transition-colors ${isActive ? 'text-primary' : 'hover:text-primary'}`} onClick={() => setOpen(false)}>Gallery</NavLink>
