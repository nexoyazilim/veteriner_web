            ...
            <div className="container mx-auto h-full px-4 sm:px-6 lg:px-8">
              <div className="h-full flex items-center">
                <div className="max-w-3xl">
                  ...
                  <a className="inline-flex items-center justify-center px-8 py-3 text-base font-bold bg-primary text-background-dark rounded-full hover:bg-primary/90 transition-transform transform hover:scale-105" href="#">
                    Book Appointment
                  </a>
                </div>
              </div>
